...
with open('model/model_res.pkl', 'rb') as file:
...
def main():
    st.title("Resume Insights Studio", anchor=None)
    st.markdown('<p class="big-font">Unlock the Power of Your Resume: Predict Domains and Visualize Key Words!</p>', unsafe_allow_html=True)
    ...
    if resume_text and st.button("Analyze Resume"):
        with st.spinner("Analyzing..."):
            ...
            st.markdown(f"## Predicted Domain: **{category}**")
